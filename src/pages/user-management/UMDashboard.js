...
const handleAddUserInputChange = (e) => {
  ...
  useEffect(() => {
    const fetchUsersAndAdmins = async () => {
      try {
        const userResponse = await axios.get('https://rude-andrei-deadlycompliance420-98f4d407.koyeb.app/api/admin/approved-users');
        const adminResponse = await axios.get('https://rude-andrei-deadlycompliance420-98f4d407.koyeb.app/api/admin/admins');
        const pendingUserResponse = await axios.get('https://rude-andrei-deadlycompliance420-98f4d407.koyeb.app/api/admin/pending-users'); // Fetch pending users
  ...
  const handleAddUserSubmit = async () => {
    try {
      ...
      await axios.post('https://rude-andrei-deadlycompliance420-98f4d407.koyeb.app/api/admin/add-users', userToAdd); // Send request to backend
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://rude-andrei-deadlycompliance420-98f4d407.koyeb.app/api/admin/users/${id}`);
  ...
  const handleEditSubmit = async () => {
    try {
      ...
      await axios.put(`https://rude-andrei-deadlycompliance420-98f4d407.koyeb.app/api/admin/users/${selectedUser._id}`, updatedUser); // Update user in the database
      setUsers((prevUsers) =>
        prevUsers.map((user) =>
  ...
  const handleApprove = async (userId) => {
    try {
      await axios.put('https://rude-andrei-deadlycompliance420-98f4d407.koyeb.app/api/admin/approve-user/${userId}`);  // Approve the user
  ...
  const handleReject = async (userId) => {
    try {
      await axios.delete(`https://rude-andrei-deadlycompliance420-98f4d407.koyeb.app/api/admin/reject-user/${userId}`);  // Reject the user
      setPendingUsers((prevPending) => prevPending.filter((user) => user._id !== userId));  // Remove from pending list
    } catch (error) {
